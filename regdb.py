...
def get_data(name, split_id, data_dir, height, width, batch_size, num_instances,
    ...
    #print("Number of training classes:" + str(dataset.num_trainval_ids))
...
def main(args):
    ...
    for ii in range(1,11):
        ...
        # Skip training and conducting evaluation in python
        if args.evaluate:
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            top1, cmc, mAP = evaluator.evaluate(query_loader, gallery_loader, metric)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'Exp_RegDB/RegDB_2'))
    # hyper-parameters
